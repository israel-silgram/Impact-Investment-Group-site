  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-[0.14em] text-ink-muted">Overall match</p>
          <p className="mt-1 inline-block font-heading text-3xl font-bold leading-none text-ink">
            <span className="border-b-2 border-orange-500 pb-1">{matchOverall}</span>
          </p>
        </div>
        <p className="font-heading text-sm font-semibold text-ink-muted">3-bed terrace · M14</p>
      </div>

      <div className="mt-6 rounded-[var(--radius-panel)] border border-teal-600/60 bg-tint-teal/40 p-5">
        <p className="eyebrow text-teal-600">Evidence</p>
        ...
        <ul className="mt-5 space-y-2 border-t border-teal-600/40 pt-4">
          {[
            ...
            >
              ...
              <ShieldCheck aria-hidden="true" className="mt-0.5 size-3.5 shrink-0 text-teal-600" />
              <span>{line}</span>
            </li>
          ))}
        </ul>
      ...
      <div className="mt-5 flex items-center justify-between gap-4 rounded-[10px] border border-rule bg-page/50 px-4 py-3">
        <span className="text-[13px] text-ink-muted">Awaiting officer confirmation</span>
        <span className="inline-flex min-h-11 items-center gap-2 font-heading text-sm font-semibold text-teal-600">
          Confirm placement
